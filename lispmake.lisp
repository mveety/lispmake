...
(defun buildexe (outstream fname package toplevel)
  (format outstream "(sb-ext:save-lisp-and-die \"~A\" :executable t :toplevel #'~A:~A)~%"
...
(defun generate ()
  (with-open-file (mkfile "build.lisp" :direction :output :if-exists :supersede)
    ...
    (if *generate*
	(buildexe mkfile *outfile* *lm-package* *toplevel*))
